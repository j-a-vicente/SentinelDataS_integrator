"""
Nesta está do mudolo Active Directory, os itens extraidos será do objeto [group]
...
class ad_group:
    ...
    # 6 - Inicia o processo de extração:
        self.total_registro_insert = self.listar_group()
    ...
    def gravarLog(self):
        #print(F"Estapa: ad_group, LogPai:{str(self.idlot)}, Total de registro:{str(self.total_registro_insert)}, dhInicial:{self.dhinicial}, dhFinal: {self.dhfinal}, Resultado: {self.execEtapa} ")
        ...
        insert_query = insert_query + "\n"+ F"('{str(self.idlot)}','ActiveDirectory','ad_group','{self.execEtapa}','{str(self.total_registro_insert)}','{self.dhinicial}','{self.dhfinal}'  )" +';'				
    ...
    def gravar(self, insert_v):
        ...
        # Monta o valores de inserts.
        insert_query = """INSERT INTO stage.ad_group(cont,name, description, samaccountname, member, memberof, distinguishedname, objectcategory, objectclass, whencreated, whenchanged) VALUES """ 
    ...
    def listar_group(self):
        ...
        truncatQuery = 'truncate table stage.ad_group'
    ...
    # Variáveis:
        ...
        try:        
            ...
            attributes=['objectsid', 'name', 'description', 'samaccountname', 'member', 'memberof', 'distinguishedname', 'objectcategory', 'objectclass', 'whencreated', 'whenchanged']
...
if __name__ == "__main__":
    ...
    ad_group_return = ad_group(idlog_etl)
    print(ad_group_return)
