"""
Nesta está do mudolo Active Directory, os itens extraidos será do objeto [Computador]
...
class ad_computador:
    ...
    # 6 - Inicia o processo de extração:
        self.total_registro_insert = self.listar_computadores()
    ...
    def gravarLog(self):
       # print(F"Estapa: ad_computador, LogPai:{str(self.idlot)}, Total de registro:{str(self.total_registro_insert)}, dhInicial:{self.dhinicial}, dhFinal: {self.dhfinal}, Resultado: {self.execEtapa} ")
        ...
        insert_query = insert_query + "\n"+ F"('{str(self.idlot)}','ActiveDirectory','ad_computador','{self.execEtapa}','{str(self.total_registro_insert)}','{self.dhinicial}','{self.dhfinal}'  )" +';'				
...
if __name__ == "__main__":
    ...
    ad_computador_return = ad_computador(idlog_etl)
    print(ad_computador_return)
    #ad_computador_return.listar_computadores()        
