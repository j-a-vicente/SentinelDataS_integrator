...
SELECT table_schema  -- 0 - Nome da base de dados
     , CAST( (SUM( data_length + index_length ) / 1024 /1024) AS DECIMAL(10,2) ) AS 'Size' -- 1 - tamanho da base de dados em Megabytes.
