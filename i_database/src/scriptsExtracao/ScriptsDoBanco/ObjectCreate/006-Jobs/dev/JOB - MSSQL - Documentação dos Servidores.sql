...
/****** Object:  Job [MSSQL - Documentação dos Servidores]    Script Date: 19/06/2022 15:45:40 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 19/06/2022 15:45:40 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Instancia]    Script Date: 19/06/2022 15:45:40 ******/
...
DEALLOCATE intancia_for', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Base de dados]    Script Date: 19/06/2022 15:45:40 ******/
...
DEALLOCATE intancia_for', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Schema, tabelas, coluna e index]    Script Date: 19/06/2022 15:45:40 ******/
...
DEALLOCATE intancia_for', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Role, Login e Membro]    Script Date: 19/06/2022 15:45:40 ******/
...
DEALLOCATE intancia_for', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Discos dos server host]    Script Date: 19/06/2022 15:45:40 ******/
...
$SQLQueryOutput |  foreach {
    ...
    $disk = Get-WMIObject -ComputerName $servidor Win32_LogicalDisk |
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Index Estatísticas]    Script Date: 19/06/2022 15:45:40 ******/
