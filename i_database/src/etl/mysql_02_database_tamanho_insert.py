...
class mysql_02_insert_database_tamanho:
    ...
    def gravarLog(self):
        ...
        insert_query = insert_query + "\n"+ F"('{str(self.idlot)}','mddados','mysql_02_insert_database_tamanho','{util.remover_aspas(self.execEtapa)}','{str(self.total_registro_insert)}','{self.dhinicial}','{self.dhfinal}'  )" +';'				
        ...
        with open(F'{self.dir_dn}Sentinel_list_instacia.sql', 'r') as arquivo_sql:
            ...
            if success:
                for o_row in o_result: 
                    ...
                    with open(F'{self.dir_dn}mysql_02_insert_tamanho_database.sql', 'r') as arquivo_sql:
                        o_query = arquivo_sql.read()
...
if __name__ == "__main__":
    ...
    mysql_02_insert_database_tamanho_return = mysql_02_insert_database_tamanho(idlog_etl)
    print(mysql_02_insert_database_tamanho_return)    