"""
Nesta está do mudolo Active Directory, os itens extraidos será do objeto [GPO]
...
class ad_gpo:
    ...
    # 6 - Inicia o processo de extração:
        self.total_registro_insert = self.listar_gpo()
    ...
    def gravarLog(self):
        #print(F"Estapa: ad_gpo, LogPai:{str(self.idlot)}, Total de registro:{str(self.total_registro_insert)}, dhInicial:{self.dhinicial}, dhFinal: {self.dhfinal}, Resultado: {self.execEtapa} ")
        ...
        insert_query = insert_query + "\n"+ F"('{str(self.idlot)}','ActiveDirectory','ad_gpo','{self.execEtapa}','{str(self.total_registro_insert)}','{self.dhinicial}','{self.dhfinal}'  )" +';'				
...
if __name__ == "__main__":
    ...
    ad_gpo_return = ad_gpo(idlog_etl)
    print(ad_gpo_return)
