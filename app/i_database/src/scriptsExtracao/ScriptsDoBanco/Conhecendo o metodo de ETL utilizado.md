# Conhecendo o metodo de ETL utilizado no projeto. 
ETL - Extract, Transform e Load, é  o metodo utilizado para extrair, transformar e carregar os dados de um lado para outro, neste caso os meta dados dos servidores e instância 
de banco de dados.

Para conexão com os bancos de dados serão utilizados os drivers de conexão ODBC de cada SGBD, dentro do SQL Server será criado um Linked Server para cadas servidor monitorado.

Devido o alto volume de servidores fica inviável a criação manual de cada Linked Server, com isto form construido duas SP para criar e deletar os Linked Server em tempo 
de execução para cada servidor.

Os script de extração ficaram dentro de um Job do SQL Server Agent.


## Extração:

### ServerHost:
No caso dos servidores os sistemas operacionais Linux e Windows, foram utilizados script em Shell para Linux e PowerShell para o Windows.

#### Windows


Script: [windows_01_insert_hostname.ps1](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/windows_01_insert_hostname.ps1)


Dados que seram extraidos:
* Unidades de HD's instalado no servidor.
* Volumetria dos HD's

Observação: o usuário configurando no servidor do SQL Agent será o responsavel por executar o script com isto está conta deverá ter acesso remoto aos servidores
que seram monitorados.
Script:
```
#Instância do banco de dados que será gravado os dados exportados.
$SQLInstance = "XXXX\XXXXX"
...
```
#### Linux:
Até este monento os script para Linux não foram desenvolvidos.


### SGBD:
Devido cada SGBD utilizar um driver de conexão diferênte, os ETL foram agrupados por SGBD: SQL Server, Oracle, PostgreSQL e MySQL.


#### SQL Server:
Script de extração executado nos servidores a serem monitorados.
| Script                           | Descrição                                                    |
|----------------------------------|--------------------------------------------------------------|
|[sql_00_insert_memory_cpu_vs.sql](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_00_insert_memory_cpu_vs.sql)   | Lista a memória RAM do servidor, a configuração de RAM para instância, CPU, versão do S.O. e do SGBD. |
|[sql_01_insert_database](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_01_insert_database.sql)| Lista todas as databases da intância.|
|[sql_02_insert_tamanho_database](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_02_insert_tamanho_database.sql)    | Extrai o volume da database.|
|[sql_03_insert_tabela](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_03_insert_tabela.sql)              | Lista todas os Schemas e as tabelas das databases.|
|[sql_04_insert_colunas](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_04_insert_colunas.sql)             | Lista todas as colunas das tabelas.|
|[sql_05_insert_index](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_05_insert_index.sql)               | Lista todos os index das tabelas.|
|[sql_06_insert_login](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_06_insert_login.sql)               | Lista dos os usuário e o nível de acesso na instância de banco.|
|[sql_07_insert_roles](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/sql_07_insert_roles.sql)               | Lista todos as "Roles" grupos de acesso e os usuários com acesso a este grupo. |

## Script completo de extração.
Este script ficaram dentro do job de extração.


### Nome do job: MSSQL - __Documentação dos Servidores__.
Todos os script tem o mesmo fluxo de execução:
 1. Lista todos os servidores.
 2. Verifica se existe linked server configurado. 
 	* Se não existir criar o linked server.
...
#### Como o script de extração é executado dentro do job. 
Os script de extração são executados usando o comando `SELECT * FROM OPENQUERY(select)` os script é carregado junto com os outros paramentros, que são executados de uma vez.

#### Vamos agora lista e explica da `step` do job __Documentação dos Servidores__.

[__Step: Instancia__](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ObjectCreate/Jobs/dev/00_sqlserver_instancia.sql)
```
/************************************************************************************************
...
[__Step: Base de dados__.](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ObjectCreate/Jobs/dev/01_sqlserver_basededados.sql)
```
/************************************************************************************************
...
[__Step: Schema, tabelas, coluna e index__.](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ObjectCreate/Jobs/dev/02_sqlserver_schema_tabela_coluna_index.sql)
```
/************************************************************************************************
Este script vai extrair os meta dados das bases de dados do servidor de SQL Server.
...
[__Step: Role, Login e Membro__](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ObjectCreate/Jobs/dev/03_sqlserver_login_role.sql)
```
/************************************************************************************************
Este script vai extrair os meta dados das bases de dados do servidor de SQL Server.
...
[__Step: Discos dos server host__, este script é em PowerShell.](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ScriptDeExtracao/windows_01_insert_hostname.ps1)
```
#Instância do banco de dados que será gravado os dados exportados.
$SQLInstance = "XXXXX\XXXXX"
...
[__Step: Index fragmentandos__.](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ObjectCreate/Jobs/dev/04_sqlserver_index_frag.sql)
```
/************************************************************************************************
Este script vai extrair os meta dados das bases de dados do servidor de SQL Server.
...
[__Step: Index estatísticas__.](https://github.com/maxabelardo/monitodatabase/blob/master/DicionarioDeDados/Scripts%20do%20banco/ObjectCreate/Jobs/dev/05_sqlserver_index_rw.sql)
```
/************************************************************************************************
Este script vai extrair os meta dados das bases de dados do servidor de SQL Server.
